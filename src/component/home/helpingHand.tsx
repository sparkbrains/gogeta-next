    ...
    <Container>
        <Row className='align-items-md-center'>
            <Col md={6} className='d-none d-sm-block'>
                <Image width={372} height={499} alt='support' src='/go/assets/img/Illustration-Support.svg' className={'support img-fluid'} />
            </Col>
            <Col md={6} >
                <MainHead title="A helping hand" />
                <Image width={372} height={499} alt='support' src='/go/assets/img/Illustration-Support.svg' className={'d-block d-sm-none support img-fluid'} />
                <Row className='pt-4'>
                    <div className='speakExpert'>
                        <Image width={67} height={66} alt='ico' src='/go/assets/img/helping-speak.svg' />
